...
const locationurl = "http://localhost:5001/location";
const restUrl = "http://localhost:5001/restaurant/stateId=";
...
class Search extends Component {
    ...
    render(){
        ...
        return(
            ...
            <Link className='orders' to="/viewOrderApi"> Your Orders</Link>
            </>
        )
    }
